...
if __name__ == "__main__":
	...
	arg.add_argument("-p", "--progress-bar", type=bool, help="Whether to show a progress bar", default=bool(int(getenv("PROGRESS_BAR", default=True))), required=bool(int(getenv("PROGRESS_BAR", default=True))) == None)
